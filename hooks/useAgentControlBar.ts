...
export interface UseAgentControlBarReturn {
  ...
  microphoneToggle: ReturnType<typeof useTrackToggle>;
  cameraToggle: ReturnType<typeof useTrackToggle>;
  screenShareToggle: ReturnType<typeof useTrackToggle>;
...
export function useAgentControlBar(props: UseAgentControlBarProps = {}): UseAgentControlBarReturn {
  ...
  const handleToggleMicrophone = React.useCallback(
    ...
    [microphoneToggle.enabled, microphoneToggle.toggle, saveAudioInputEnabled]
  );
